          ...
          >
            ...
            {action.id === 'open-scripts' ? (
              <svg className="h-4 w-4 shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 5.75A1.75 1.75 0 0 1 6.75 4h10.5A1.75 1.75 0 0 1 19 5.75v12.5A1.75 1.75 0 0 1 17.25 20H6.75A1.75 1.75 0 0 1 5 18.25Z" />
              </svg>
            ) : null}
            {action.label}
          </button>
